...
def ElasticNetGrid(trial):
    param_grid = {
        "alpha"    : trial.suggest_float("alpha", 1e-1, 1.0, step=0.005),
        "l1_ratio" : trial.suggest_float("l1_ratio", 0.35, 0.65, step=0.005),
                 }
...
def LightGBMGrid(trial):
    ...
    param_grid = {
        "objective"              : "huber",
        "alpha"                  : trial.suggest_float("alpha", 0.05, 2.0, step=0.05),
