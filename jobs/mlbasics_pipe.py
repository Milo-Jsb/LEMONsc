...
from src.processing.features import tabular_features, filter_simulation_artifacts, TargetLogScaler
...
class TrainingConfig:
    ...
    -> use_scaler     : Whether to apply feature scaling to the input features (default: True).
